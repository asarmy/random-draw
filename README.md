...
The web application can be accessed through GitHub pages at: [https://asarmy.github.io/random-draw/](https://asarmy.github.io/random-draw/). Random draws can be generated and saved to PDF here. There is also a link to the Monte Carlo validation exercise.
